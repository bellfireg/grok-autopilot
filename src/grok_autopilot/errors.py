"""
Grok Autopilot — Custom Exceptions
=====================================
...
class GrokAutopilotError(Exception):
    """Base exception for all Grok Autopilot errors."""
...
class TempMailError(GrokAutopilotError):
...
class CaptchaError(GrokAutopilotError):
...
class RegistrationError(GrokAutopilotError):
...
class OAuthError(GrokAutopilotError):
...
class NineRouterError(GrokAutopilotError):
