"""
Grok Autopilot — User Config Manager
=======================================
Persistent user configuration stored in ~/.grok-autopilot/config.json.
...
Usage:
    from grok_autopilot.user_config import load_user_config, save_user_config
...
CONFIG_DIR = Path.home() / ".grok-autopilot"
...
def save_user_config(cfg: dict) -> Path:
    """Save user config to ~/.grok-autopilot/config.json.
