"""
Grok Autopilot — 9Router Integration
=======================================
Insert Grok account connections directly into 9Router's SQLite database.
...
def add_to_9router_device(
    ...
    """Add a Grok connection to 9Router DB using device token response.
