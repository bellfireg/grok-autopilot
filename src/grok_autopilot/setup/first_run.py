"""
Grok Autopilot — First Run Wizard
=====================================
...
def is_first_run() -> bool:
    """Check if this is the first time running grok-autopilot."""
...
def run_first_run_wizard() -> bool:
    ...
    print()
    print(f"{BOLD}  ╔══════════════════════════════════════════════════╗{NC}")
    print(f"{BOLD}  ║       👋 Welcome to grok-autopilot!             ║{NC}")
    print(f"{BOLD}  ║       Let's get you set up in 30 seconds.        ║{NC}")
    print(f"{BOLD}  ╚══════════════════════════════════════════════════╝{NC}")
    print()
    print(f"  {DIM}This tool automates Grok account registration.{NC}")
...
def _offer_doctor() -> None:
    ...
    print(f"  {BOLD}[?]{NC} Run health check now? ({DIM}grok-autopilot doctor{NC})")
    ...
    if run == "y":
        ...
        print()
        print(f"  {DIM}You can run it anytime with: grok-autopilot doctor{NC}")
        print()
